      ...
      <div class="row no-gutters">
        ...
        <div class="col-md-2 bg-dark mt-2 pr-3 pt-1 sidebar position-fixed" style="width: 15em;">
          <ul class="nav flex-column mb-5 isi_sidebar">
            ...
            <li class="nav-item mb-2">
              <a class="nav-link active text-white" href="Buku.php"
                ...
                <div class="modal-body">
                  ...
                  <div class=" mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" name="lokasi" placeholder="masukan lokasi buku">
                    </div>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                          ...
                          <div class="mb-3 text-center">
                            <img src="gambar/<?= $row['gambar'] ?>" class="img-thumbnail" style="width: 200px;"  alt="">
                          </div>
                          ...
                          <div class="row mb-3">
                            <div class="col-md-6 ms-auto">
                            <label for="tahun_penerbit" class="form-label">Tahun Terbit</label>
                            <input type="text" class="form-control" name="tahun_penerbit" value="<?= $row['tahun_penerbit']; ?>" readonly>
                            </div>
                            <div class="col-md-6">
                            <label for="isbn" class="form-label">isbn</label>
                          ...
                          <div class="row mb-3">
                            <div class="col-md-6 ms-auto">
                            <label for="lokasi" class="form-label">lokasi</label>
                            <input type="text" class="form-control" name="lokasi" value="<?= $row['lokasi']; ?>" readonly>
                            </div>
                            <div class="col-md-6">
                            <label for="rak" class="form-label">rak</label>
                            <input type="text" class="form-control" name="rak" value="<?= $row['rak']; ?>" readonly>
                            </div>
                          </div>
                ...
                <div class="modal fade" id="editModal<?php echo $data['id_buku']; ?>" role="dialog">
                  <div class="modal-dialog modal-dialog-scrollable">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form role="form" action="prosesEditBuku.php" method="POST" enctype="multipart/form-data"> 
                          <!--  -->
                          ...
                          <!--  -->
                            ...
                            <div class="mb-3">
                              <label for="rak" class="form-label">rak</label>
                              <input type="text" class="form-control" name="rak" value="<?= $row['rak']; ?>">
                            </div>

                            <div class="mb-3">
                            <input type="file" class="form-control" name="file" id="file"> 
                            <!-- <span><?= $row['gambar']; ?></span> -->
                            </div>
